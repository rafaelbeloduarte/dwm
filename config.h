...
static Key keys[] = {
  ...
  { ALTKEY|ShiftMask,   XK_space,          unfloatvisible, {0} },
	...
	{ 0,                  XK_F11,            spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 5%+")},
	{ 0,                  XK_F10,            spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 5%-")},
	{ ALTKEY,             XK_1,              spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 15%")},
	{ ALTKEY,             XK_2,              spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 40%")},
	{ ALTKEY,             XK_3,              spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 60%")},
	{ ALTKEY,             XK_4,              spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 100%")},
	{ MODKEY,             XK_F4,             spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ toggle")},
